...
3. Upon successful token generation, you can obtain a token as follows:
    ...
    !!! note
        The CDR Arrangement ID is a unique string that represents a consent arrangement between a Data Recipient 
        Software Product and Data Holder for a given consumer. For more information, see [Consumer Data Standards - CDR Arrangement ID](https://consumerdatastandardsaustralia.github.io/standards/#authorisation-scopes).
